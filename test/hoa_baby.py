...
from src.locators import hoa_baby as lo
...
def main(folder_name):
    ...
    main_url = "https://phomaibeo.wordpress.com/full-hoa-baby-mo-nhac-dieu/"
...
'''Note: run this code using cmd: uv run test/hoa_baby.py'''