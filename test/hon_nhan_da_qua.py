...
from src.locators import hon_nhan_da_qua as lo
...
def main(folder_name):
    ...
    chapters_list = []
    for i in range (1, 3):
        main_url = f"https://truyenfull.vision/hon-nhan-da-qua/trang-{i}/#list-chapter"
...
if __name__ == '__main__':
    main("hon_nhan_da_qua")

'''Note: run this code using cmd: uv run test/hon_nhan_da_qua.py'''