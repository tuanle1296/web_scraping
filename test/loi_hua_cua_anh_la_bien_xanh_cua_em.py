...
from src.locators import loi_hua_cua_anh_la_bien_xanh_cua_em as lo
...
def main(folder_name):
    ...
    chapters_list = []
    for i in range (1, 3):
        main_url = f"https://mongtruyen.com/loi-hua-cua-anh-la-bien-xanh-cua-em.html?page={i}"
...
if __name__ == '__main__':
    main("loi_hua_cua_anh_la_bien_xanh_cua_em")

'''Note: run this code using cmd: uv run test/loi_hua_cua_anh_la_bien_xanh_cua_em.py'''
