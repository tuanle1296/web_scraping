...
from src.locators import sinh_do as lo
...
def main(folder_name):
    ...
    chapters_list = []
    for i in range (1, 3):
        main_url = f"https://truyenfull.vision/sinh-do/trang-{i}/#list-chapter"
...
'''Note: run this code using cmd: uv run test/sinh_do.py'''
