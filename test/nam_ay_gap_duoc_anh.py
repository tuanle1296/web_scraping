...
from src.locators import nam_ay_gap_duoc_anh as lo
...
def main(folder_name):
    ...
    main_url = "https://truyenfull.vision/nam-ay-gap-duoc-anh/"
...
if __name__ == '__main__':
    main("nam_ay_gap_duoc_anh")

'''Note: run this code using cmd: uv run test/nam_ay_gap_duoc_anh.py'''