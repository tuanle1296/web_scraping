...
from src.locators import anh_trang_roi_vao_be_tinh as lo
...
def crawl_worker(chapter_data, folder_name):
    ...
    try:
        ...
        pass
    passwords = "NiennienTuyentuyen"
    
    for chap_url, chap_num in chapter_data:
        if (chap_num == 20):
            chap_url = "https://sakurahousene.wordpress.com/2022/07/10/atrvbt-chuong-20/"
...
def main(folder_name):
    ...
    main_url = "https://sakurahousene.wordpress.com/portfolio/anh-trang-roi-vao-be-tinh/"
...
if __name__ == '__main__':
    main("anh_trang_roi_vao_be_tinh")

'''Note: run this code using cmd: uv run test/anh_trang_roi_vao_be_tinh.py'''