...
from src.locators import o_lai_trong_long_anh as lo
...
def main(folder_name):
    ...
    main_url = "https://jolinasland.wordpress.com/o-lai-trong-long-anh/"
...
if __name__ == '__main__':
    main("o_lai_trong_long_anh")

'''Note: run this code using cmd: uv run test/o_lai_trong_long_anh.py'''
