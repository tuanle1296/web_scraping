...
from src.locators import gio_xuan_ruc_lua as lo
...
def main(folder_name):
    ...
    chapters_list = []
    for i in range (1, 3):
        main_url = f"https://truyenfull.vision/gio-xuan-ruc-lua/trang-{i}/#list-chapter"
...
if __name__ == '__main__':
    main("gio_xuan_ruc_lua")

'''Note: run this code using cmd: uv run test/gio_xuan_ruc_lua.py'''
