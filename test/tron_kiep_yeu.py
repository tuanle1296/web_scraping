...
from src.locators import tron_kiep_yeu as lo
...
def main(folder_name):
    ...
    chapters_list = []
    for i in range (1, 3):
        main_url = f"https://truyenfull.vision/tron-kiep-yeu/trang-{i}/#list-chapter"
...
'''Note: run this code using cmd: uv run test/tron_kiep_yeu.py'''
