...
from src.locators import do_quyen_khong_tan as lo
...
def main(folder_name):
    ...
    main_url = "https://tuncoi.wordpress.com/do-quyen-khong-tan/"
...
if __name__ == '__main__':
    main("do_quyen_khong_tan")

'''Note: run this code using cmd: uv run test/do_quyen_khong_tan.py'''