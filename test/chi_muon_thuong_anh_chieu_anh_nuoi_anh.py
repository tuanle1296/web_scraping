...
from src.locators import chi_muon_thuong_anh_chieu_anh_nuoi_anh as lo
...
def main(folder_name):
    ...
    chapters_list = []
    for i in range (1, 3):
        main_url = f"https://truyenfull.vision/chi-muon-thuong-anh-chieu-anh-nuoi-anh/trang-{i}/#list-chapter"
...
if __name__ == '__main__':
    main("chi_muon_thuong_anh_chieu_anh_nuoi_anh")

'''Note: run this code using cmd: uv run test/chi_muon_thuong_anh_chieu_anh_nuoi_anh.py'''
