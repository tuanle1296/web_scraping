...
from src.locators import non_xanh_van_o_day as lo
...
def main(folder_name):
    ...
    chapters_list = []
    for i in range (1, 3):
        main_url = f"https://truyenfull.vision/non-xanh-van-o-day/trang-{i}/#list-chapter"
...
if __name__ == '__main__':
    main("non_xanh_van_o_day")

'''Note: run this code using cmd: uv run test/non_xanh_van_o_day.py'''
