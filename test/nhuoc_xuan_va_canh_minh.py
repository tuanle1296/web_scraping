...
from src.locators import nhuoc_xuan_va_canh_minh as lo
...
def main(folder_name):
    ...
    chapters_list = []
    for i in range (1, 3):
        main_url = f"https://truyenfull.vision/nhuoc-xuan-va-canh-minh/trang-{i}/#list-chapter"
...
if __name__ == '__main__':
    main("nhuoc_xuan_va_canh_minh")

'''Note: run this code using cmd: uv run test/nhuoc_xuan_va_canh_minh.py'''