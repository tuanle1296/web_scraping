...
from src.locators import tan_hon as lo
...
def main(folder_name):
    ...
    chapters_list = []
    # main_url = "https://theatlamtis0108.wordpress.com/2021/03/08/hoan-tan-hon-ban-tiet-bach-thai/"
    main_url = "https://truyenfull.vision/tan-hon-ban-tiet-bach-thai/chuong-101/"
    ...
    title = crawl.get_element_text(chapter_title)
    content = crawl.get_element_text(chapter_content)
    crawl.add_text_to_doc_file(title, content, "chapter_101")
...
'''Note: run this code using cmd: uv run test/tan_hon.py'''
