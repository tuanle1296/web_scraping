...
from src.locators import thien_huong_nguoi_mu as lo
...
def main(folder_name):
    ...
    main_url = "https://tuutuuu0702.wordpress.com/2023/02/09/87/"
...
if __name__ == '__main__':
    main("thien_huong_nguoi_mu")

'''Note: run this code using cmd: uv run test/thien_huong_nguoi_mu.py'''
