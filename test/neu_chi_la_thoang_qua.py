...
from src.locators import neu_chi_la_thoang_qua as lo
...
def main(folder_name):
    ...
    chapters_list = []
    main_url = f"https://truyenfull.vision/neu-chi-la-thoang-qua/"
...
if __name__ == '__main__':
    main("neu_chi_la_thoang_qua")

'''Note: run this code using cmd: uv run test/neu_chi_la_thoang_qua.py'''
