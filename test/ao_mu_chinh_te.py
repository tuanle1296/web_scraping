...
from src.locators import ao_mu_chinh_te as lo
...
def main(folder_name):
    ...
    chapters_list = []
    for i in range (1, 7):
        main_url = f"https://mongtruyen.com/ao-mu-chinh-te.html?page={i}"
...
'''Note: run this code using cmd: uv run test/ao_mu_chinh_te.py'''
