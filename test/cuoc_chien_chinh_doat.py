...
from src.locators import cuoc_chien_chinh_doat as lo
...
def main(folder_name):
    ...
    main_url = "https://gacsach3.top/cuoc-chien-chinh-doat_kim-binh.full"
...
if __name__ == '__main__':
    main("cuoc_chien_chinh_doat")

'''Note: run this code using cmd: uv run test/cuoc_chien_chinh_doat.py'''