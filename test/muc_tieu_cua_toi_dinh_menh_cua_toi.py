...
from src.locators import muc_tieu_cua_toi_dinh_menh_cua_toi as lo
...
def main(folder_name):
    ...
    chapters_list = []
    for i in range (1, 3):
        main_url = f"https://truyenfull.vision/muc-tieu-cua-toi-dinh-menh-cua-toi/trang-{i}/#list-chapter"
...
if __name__ == '__main__':
    main("muc_tieu_cua_toi_dinh_menh_cua_toi")

'''Note: run this code using cmd: uv run test/muc_tieu_cua_toi_dinh_menh_cua_toi.py'''