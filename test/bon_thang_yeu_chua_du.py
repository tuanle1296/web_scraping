...
from src.locators import bon_thang_yeu_chua_du as lo
...
def main(folder_name):
    ...
    chapters_list = []
    main_url = f"https://gacsach.org/bon-thang-yeu-chua-du_nhan-hai-trung.full"
...
if __name__ == '__main__':
    main("bon_thang_yeu_chua_du")

'''Note: run this code using cmd: python3 test/bon_thang_yeu_chua_du.py'''
