...
from src.locators import nghiem_tuc_ho_nhao as lo
...
def main(folder_name):
    ...
    chapters_list = []
    main_url = f"https://truyenfull.vision/nghiem-tuc-ho-nhao/"
...
if __name__ == '__main__':
    main("nghiem_tuc_ho_nhao")

'''Note: run this code using cmd: uv run test/nghiem_tuc_ho_nhao.py'''
