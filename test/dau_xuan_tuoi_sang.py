...
from src.locators import dau_xuan_tuoi_sang as lo
...
def main(folder_name):
    ...
    chapters_list = []
    for i in range (1, 4):
        main_url = f"https://truyenfull.vision/dau-xuan-tuoi-sang/trang-{i}/#list-chapter"
...
if __name__ == '__main__':
    main("dau_xuan_tuoi_sang")

'''Note: run this code using cmd: uv run test/dau_xuan_tuoi_sang.py'''