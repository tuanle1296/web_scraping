...
from src.locators import minh_nguyet_lac_nga_hoai as lo
...
def main(folder_name):
    ...
    main_url = "https://mintleafhouse.wordpress.com/2020/03/15/minh-nguyet-lac-nga-hoai-2/"
...
if __name__ == '__main__':
    main("minh_nguyet_lac_nga_hoai")

'''Note: run this code using cmd: uv run test/minh_nguyet_lac_nga_hoai.py'''