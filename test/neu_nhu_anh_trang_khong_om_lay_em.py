...
from src.locators import neu_nhu_anh_trang_khong_om_lay_em as lo
...
def main(folder_name):
    ...
    chapters_list = []
    for i in range (1, 3):
        main_url = f"https://truyenfull.vision/neu-nhu-anh-trang-khong-om-lay-em/trang-{i}/#list-chapter"
...
if __name__ == '__main__':
    main("neu_nhu_anh_trang_khong_om_lay_em")

'''Note: run this code using cmd: uv run test/neu_nhu_anh_trang_khong_om_lay_em.py'''