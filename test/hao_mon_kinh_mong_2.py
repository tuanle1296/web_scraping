...
from src.locators import hao_mon_kinh_mong_2 as lo
...
def main(folder_name):
    ...
    with Base(False) as crawl:
        ...
        chapters_list = []
        for i in range (1, 15):
            main_url = f"https://docsach24.co/e-book/hao-mon-kinh-mong-2-khe-uoc-dan-ukulele-1734.html?page={i}"
...
if __name__ == '__main__':
    main("hao_mon_kinh_mong_2")

'''Note: run this code using cmd: uv run test/hao_mon_kinh_mong_2.py'''