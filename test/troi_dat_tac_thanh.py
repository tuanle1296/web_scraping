...
from src.locators import troi_dat_tac_thanh as lo
...
def main(folder_name):
    ...
    with Base(False) as crawl:
        ...
        main_url = "https://gacsach3.top/troi-dat-tac-thanh_tang-gioi.full"
...
if __name__ == '__main__':
    main("troi_dat_tac_thanh")

'''Note: run this code using cmd: uv run test/troi_dat_tac_thanh.py'''