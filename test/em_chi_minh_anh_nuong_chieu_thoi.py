...
from src.locators import em_chi_minh_anh_nuong_chieu_thoi as lo
...
def main(folder_name):
    ...
    chapters_list = []
    for i in range (1, 4):
        main_url = f"https://metruyenhot.vn/truyen-em-chi-minh-anh-nuong-chieu-thoi-on-thu-du-tac-gia-le-vu?page={i}"
...
if __name__ == '__main__':
    main("em_chi_minh_anh_nuong_chieu_thoi")

'''Note: run this code using cmd: uv run test/em_chi_minh_anh_nuong_chieu_thoi.py'''
