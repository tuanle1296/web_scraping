...
from src.locators import vi_gio_o_noi_ay as lo
...
def main(folder_name):
    ...
    chapters_list = []
    main_url = "https://truyenfull.vision/vi-gio-o-noi-ay/"
...
if __name__ == '__main__':
    main("vi_gio_o_noi_ay")

'''Note: run this code using cmd: uv run test/vi_gio_o_noi_ay.py'''