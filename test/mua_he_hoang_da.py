...
from src.locators import mua_he_hoang_da as lo
...
def main(folder_name):
    ...
    chapters_list = []
    for i in range (1, 10):
        main_url = f"https://mongtruyen.com/mua-he-hoang-da.html?page={i}"
...
if __name__ == '__main__':
    main("mua_he_hoang_da")

'''Note: run this code using cmd: uv run test/mua_he_hoang_da.py'''
