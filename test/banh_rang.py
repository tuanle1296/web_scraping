...
from src.locators import banh_rang as lo
...
def main(folder_name):
    ...
    main_url = "https://lastella502.wordpress.com/2019/11/15/edit-ngon-tinh-banh-rang-tuyen-truc/"
...
'''Note: run this code using cmd: uv run test/banh_rang.py'''
