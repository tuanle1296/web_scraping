...
from src.locators import doan_tau_trong_suong_mu as lo
...
def crawl_worker(chapter_data, folder_name):
    ...
    passwords = "phuonghanganIUvantuyetahihi"
...
def main(folder_name):
    ...
    main_url = "https://blueavenue00.wordpress.com/doan-tau-trong-suong-mu-lam-sau-tu/"
...
if __name__ == '__main__':
    main("doan_tau_trong_suong_mu")

'''Note: run this code using cmd: uv run test/doan_tau_trong_suong_mu.py'''
