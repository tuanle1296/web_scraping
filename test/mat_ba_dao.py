...
from src.locators import mat_ba_dao as lo
...
def main(folder_name):
    ...
    chapters_list = []
    for i in range (1, 3):
        main_url = f"https://truyenfull.vision/mat-ba-dao/trang-{i}/#list-chapter"
...
'''Note: run this code using cmd: uv run test/mat_ba_dao.py'''