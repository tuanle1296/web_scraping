...
from src.locators import den_sang_khi_nguoi_den as lo
...
def main(folder_name):
    ...
    main_url = "https://muadongsaigon.wordpress.com/2021/10/18/den-sang-khi-nguoi-den/"
...
if __name__ == '__main__':
    main("den_sang_khi_nguoi_den")

'''Note: run this code using cmd: uv run test/den_sang_khi_nguoi_den.py'''