...
from src.locators import khong_biet_sao_yeu_em as lo
...
def main(folder_name):
    ...
    main_url = "https://tieutayme.wordpress.com/khong-biet-sao-yeu-em/"
    
    chapters_list = []
    # forbidden_words = ["share"]
...
if __name__ == '__main__':
    main("khong_biet_sao_yeu_em")

'''Note: run this code using cmd: uv run test/khong_biet_sao_yeu_em.py'''