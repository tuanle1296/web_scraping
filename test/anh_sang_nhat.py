...
from src.locators import anh_sang_nhat as lo
...
def main(folder_name):
    ...
    main_url = "https://bordeauxbar.wordpress.com/cao-h-anh-sang-nhat/"
...
'''Note: run this code using cmd: uv run test/anh_sang_nhat.py'''