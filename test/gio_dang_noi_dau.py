...
from src.locators import gio_dang_noi_dau as lo
...
def main(folder_name):
    ...
    chapters_list = []
    for i in range (1, 5):
        main_url = f"https://truyenfull.vision/gio-dang-noi-dau/trang-{i}/#list-chapter"
...
if __name__ == '__main__':
    main("gio_dang_noi_dau")

'''Note: run this code using cmd: uv run test/gio_dang_noi_dau.py'''