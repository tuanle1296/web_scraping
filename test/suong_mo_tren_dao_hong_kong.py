...
from src.locators import suong_mo_tren_dao_hong_kong as lo
...
def main(folder_name):
    ...
    main_url = "https://heliophilia3.wordpress.com/2024/09/01/van-an/"
...
if __name__ == '__main__':
    main("suong_mo_tren_dao_hong_kong")

'''Note: run this code using cmd: python3 test/suong_mo_tren_dao_hong_kong.py'''
