...
from src.locators import nguyen_tran_an_tinh as lo
...
def main(folder_name):
    ...
    main_url = "https://truyenfull.vision/nguyen-tran-an-tinh/"
...
if __name__ == '__main__':
    main("nguyen_tran_an_tinh")

'''Note: run this code using cmd: uv run test/nguyen_tran_an_tinh.py'''