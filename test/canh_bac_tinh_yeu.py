...
from src.locators import canh_bac_tinh_yeu as lo
...
def main(folder_name):
    ...
    chapters_list = []
    for i in range (1, 3):
        main_url = f"https://truyenfull.vision/canh-bac-tinh-yeu/trang-{i}/#list-chapter"
...
if __name__ == '__main__':
    main("canh_bac_tinh_yeu")

'''Note: run this code using cmd: uv run test/canh_bac_tinh_yeu.py'''
