...
from src.locators import ca_voi_co_don as lo
...
def main(folder_name):
    ...
    chapters_list = []
    for i in range (1, 3):
        main_url = f"https://truyenfull.vision/ca-voi-co-don/trang-{i}/#list-chapter"
...
'''Note: run this code using cmd: uv run test/ca_voi_co_don.py'''