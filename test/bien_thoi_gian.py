...
from src.locators import bien_thoi_gian as lo
...
def main(folder_name):
    ...
    main_url = "https://luclacnho2810.wordpress.com/bien-thoi-gian-doan-tieu-tieu/"
...
'''Note: run this code using cmd: uv run test/bien_thoi_gian.py'''
