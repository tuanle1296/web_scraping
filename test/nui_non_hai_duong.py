...
from src.locators import nui_non_hai_duong as lo
...
def main(folder_name):
    ...
    chapters_list = []
    for i in range (1, 5):
        main_url = f"https://mongtruyen.com/nui-non-hai-duong.html?page={i}"
...
if __name__ == '__main__':
    main("nui_non_hai_duong")

'''Note: run this code using cmd: uv run test/nui_non_hai_duong.py'''
