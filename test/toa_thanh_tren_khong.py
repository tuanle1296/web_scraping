...
from src.locators import toa_thanh_tren_khong as lo
...
def main(folder_name):
    ...
    chapters_list = []
    for i in range (1, 6):
        main_url = f"https://mongtruyen.com/toa-thanh-tren-khong.html?page={i}"
...
if __name__ == '__main__':
    main("toa_thanh_tren_khong")

'''Note: run this code using cmd: uv run test/toa_thanh_tren_khong.py'''
