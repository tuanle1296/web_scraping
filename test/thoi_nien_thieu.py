...
from src.locators import thoi_nien_thieu as lo
...
def main(folder_name):
    ...
    main_url = "https://truyenfull.vision/thoi-nien-thieu/"
...
if __name__ == '__main__':
    main("thoi_nien_thieu")

'''Note: run this code using cmd: uv run test/thoi_nien_thieu.py'''
