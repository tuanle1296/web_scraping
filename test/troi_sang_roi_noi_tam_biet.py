...
from src.locators import troi_sang_roi_noi_tam_biet as lo
...
def main(folder_name):
    ...
    chapters_list = []
    for i in range (1, 3):
        main_url = f"https://truyenfull.vision/troi-sang-roi-noi-tam-biet/trang-{i}/#list-chapter"
...
if __name__ == '__main__':
    main("troi_sang_roi_noi_tam_biet")

'''Note: run this code using cmd: uv run test/troi_sang_roi_noi_tam_biet.py'''
