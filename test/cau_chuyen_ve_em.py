...
from src.locators import cau_chuyen_ve_em as lo
...
def main(folder_name):
    ...
    chapters_list = []
    for i in range (1, 3):
        main_url = f"https://truyenfull.vision/cau-chuyen-ve-em/trang-{i}/#list-chapter"
...
if __name__ == '__main__':
    main("cau_chuyen_ve_em")

'''Note: run this code using cmd: uv run test/cau_chuyen_ve_em.py'''
