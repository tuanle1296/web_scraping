...
from src.locators import thu_kinh as lo
...
def main(folder_name):
    ...
    chapters_list = []
    for i in range (1, 3):
        main_url = f"https://truyenfull.vision/thu-kinh/trang-{i}/#list-chapter"
...
'''Note: run this code using cmd: uv run test/thu_kinh.py'''
