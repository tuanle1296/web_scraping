...
from src.locators import dau_the_nao_cung_muon_o_ben_nhau as lo
...
def main(folder_name):
    ...
    main_url = "https://grabiz.wordpress.com/hoan/dtncmobn/"
...
if __name__ == '__main__':
    main("dau_the_nao_cung_muon_o_ben_nhau")

'''Note: run this code using cmd: uv run test/dau_the_nao_cung_muon_o_ben_nhau.py'''