...
from src.locators import tinh_cam_sau_nang as lo
...
def main(folder_name):
    ...
    chapters_list = []
    for i in range (1, 3):
        main_url = f"https://metruyenhot.vn/tinh-cam-sau-nang?page={i}"
...
if __name__ == '__main__':
    main("tinh_cam_sau_nang")

'''Note: run this code using cmd: uv run test/tinh_cam_sau_nang.py'''
