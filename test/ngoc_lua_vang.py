...
from src.locators import ngoc_lua_vang as lo
...
def main(folder_name):
    ...
    chapters_list = []
    for i in range (1, 3):
        main_url = f"https://truyenfull.vision/ngoc-lua-vang/trang-{i}/#list-chapter"
...
'''Note: run this code using cmd: uv run test/ngoc_lua_vang.py'''