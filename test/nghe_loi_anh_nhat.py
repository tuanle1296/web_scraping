...
from src.locators import nghe_loi_anh_nhat as lo
...
def main(folder_name):
    ...
    chapters_list = []
    for i in range (1, 3):
        main_url = f"https://truyenfull.vision/nghe-loi-anh-nhat/trang-{i}/#list-chapter"
...
if __name__ == '__main__':
    main("nghe_loi_anh_nhat")

'''Note: run this code using cmd: uv run test/nghe_loi_anh_nhat.py'''
