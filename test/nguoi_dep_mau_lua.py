...
def main(folder_name):
    ...
    main_url = "https://mmtd1314.wordpress.com/2025/08/30/nguoi-dep-mau-lua-thuy-khuc-huu-ngan-phieu/"
...
if __name__ == '__main__':
    main("nguoi_dep_mau_lua")

'''Note: run this code using cmd: uv run test/nguoi_dep_mau_lua.py'''