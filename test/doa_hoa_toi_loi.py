...
from src.locators import doa_hoa_toi_loi as lo
...
def main(folder_name):
    ...
    chapters_list = []
    for i in range (1, 4):
        main_url = f"https://truyenfull.vision/doa-hoa-toi-loi/trang-{i}/#list-chapter"
...
if __name__ == '__main__':
    main("doa_hoa_toi_loi")

'''Note: run this code using cmd: uv run test/doa_hoa_toi_loi.py'''
