...
from src.locators import thoi_gian_nhu_hen as lo
...
def main(folder_name):
    ...
    chapters_list = []
    forbidden_words = ["onebook", "forum", "thivien", "botngoaihanhtinh", "y-sam"]
    main_url = "https://chengduchengdu.wordpress.com/thoi-gian-nhu-hen-tieu-lo/comment-page-3/"
...
if __name__ == '__main__':
    main("thoi_gian_nhu_hen")

'''Note: run this code using cmd: uv run test/thoi_gian_nhu_hen.py'''
