...
from src.locators import cam_on_em_da_dung_cam_yeu_anh as lo
...
def main(folder_name):
    ...
    chapters_list = []
    for i in range (1, 3):
        main_url = f"https://truyenfull.vision/cam-on-em-da-can-dam-yeu-anh/trang-{i}/#list-chapter"
...
if __name__ == '__main__':
    main("cam_on_em_da_dung_cam_yeu_anh")

'''Note: run this code using cmd: uv run test/cam_on_em_da_dung_cam_yeu_anh.py'''