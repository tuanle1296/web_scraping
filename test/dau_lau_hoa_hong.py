...
from src.locators import dau_lau_hoa_hong as lo
...
def main(folder_name):
    ...
    main_url = "https://lamdaunhagau.wordpress.com/dau-lau-hoa-hong-quyet-biet-tu/"
...
if __name__ == '__main__':
    main("dau_lau_hoa_hong")

'''Note: run this code using cmd: uv run test/dau_lau_hoa_hong.py'''