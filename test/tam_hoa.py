...
from src.locators import tam_hoa as lo
...
def main(folder_name):
    ...
    chapters_list = []
    for i in range (1, 3):
        main_url = f"https://truyenfull.vision/tam-hoa/trang-{i}/#list-chapter"
...
'''Note: run this code using cmd: uv run test/tam_hoa.py'''