...
from src.locators import cay_o_liu_mau_trang as lo
...
def main(folder_name):
    ...
    chapters_list = []
    for i in range (1, 3):
        main_url = f"https://truyenfull.vision/cay-o-liu-mau-trang/trang-{i}/#list-chapter"
...
if __name__ == '__main__':
    main("cay_o_liu_mau_trang")

'''Note: run this code using cmd: uv run test/cay_o_liu_mau_trang.py'''
