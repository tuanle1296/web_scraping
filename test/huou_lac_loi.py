...
from src.locators import huou_lac_loi as lo
...
def main(folder_name):
    ...
    chapters_list = []
    for i in range (1, 4):
        main_url = f"https://mongtruyen.com/huou-lac-loi.html?page={i}"
...
'''Note: run this code using cmd: uv run test/huou_lac_loi.py'''
