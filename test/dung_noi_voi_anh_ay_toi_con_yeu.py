...
from src.locators import dung_ai_noi_voi_anh_ay_toi_con_yeu as lo
...
def crawl_worker(chapter_data, folder_name):
    ...
    for chap_url, chap_num in chapter_data:
        ...
        title = crawl.get_element_text(lo.chap_header)
...
def main(folder_name):
    ...
    main_url = "https://havientx.wordpress.com/2020/05/23/dung-noi-voi-anh-ay-toi-van-con-yeu-luc-xu/"
    crawl.go_to_webpage(main_url)
    crawl.wait_for_page_load(10)
    chap_list = crawl.find_element(lo.chap_content)
...
if __name__ == '__main__':
    main("dung_ai_noi_voi_anh_ay_toi_con_yeu")

'''Note: run this code using cmd: python3 test/dung_ai_noi_voi_anh_ay_toi_con_yeu.py'''
