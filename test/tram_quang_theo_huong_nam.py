...
from src.locators import tram_quang_theo_huong_nam as lo
...
def main(folder_name):
    ...
    with Base(False) as crawl:
        ...
        main_url = "https://gacsach3.top/tram-quang-theo-huong-nam_on-thanh-hoan.full"
...
if __name__ == '__main__':
    main("tram_quang_theo_huong_nam")

'''Note: run this code using cmd: uv run test/tram_quang_theo_huong_nam.py'''