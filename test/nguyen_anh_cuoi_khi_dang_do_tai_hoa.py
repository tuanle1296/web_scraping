...
from src.locators import nguyen_anh_cuoi_khi_dang_do_tai_hoa as lo
...
def main(folder_name):
    ...
    chapters_list = []
    for i in range (1, 3):
        main_url = f"https://truyenfull.vision/nguyen-anh-cuoi-khi-dang-do-tai-hoa/trang-{i}/#list-chapter"
...
if __name__ == '__main__':
    main("nguyen_anh_cuoi_khi_dang_do_tai_hoa")

'''Note: run this code using cmd: uv run test/nguyen_anh_cuoi_khi_dang_do_tai_hoa.py'''
