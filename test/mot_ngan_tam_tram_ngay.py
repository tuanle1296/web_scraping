...
from src.locators import mot_ngan_tam_tram_ngay as lo
...
def main(folder_name):
    ...
    chapters_list = []
    for i in range (1, 3):
        main_url = f"https://truyenfull.vision/mot-ngan-tam-tram-ngay/trang-{i}/#list-chapter"
...
if __name__ == '__main__':
    main("mot_ngan_tam_tram_ngay")

'''Note: run this code using cmd: uv run test/mot_ngan_tam_tram_ngay.py'''
