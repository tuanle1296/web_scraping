...
from src.locators import cau_chuyen_ngay_xuan as lo
...
def main(folder_name):
    ...
    main_url = "https://truyenfull.vision/cau-chuyen-ngay-xuan/"
...
if __name__ == '__main__':
    main("cau_chuyen_ngay_xuan")

'''Note: run this code using cmd: uv run test/cau_chuyen_ngay_xuan.py'''
