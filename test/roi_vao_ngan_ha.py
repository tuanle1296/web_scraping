...
from src.locators import roi_vao_ngan_ha as lo
...
def main(folder_name):
    ...
    chapters_list = []
    for i in range (1, 4):
        main_url = f"https://truyenfull.vision/roi-vao-ngan-ha/trang-{i}/#list-chapter"
...
if __name__ == '__main__':
    main("roi_vao_ngan_ha")

'''Note: run this code using cmd: uv run test/roi_vao_ngan_ha.py'''