...
from src.locators import chi_la_da_nghiem_tuc_voi_em as lo
...
def main(folder_name):
    ...
    main_url = "https://tamsinhhuuhanhh.wordpress.com/chi-la-da-nghiem-tuc-voi-em-thanh-phong-ngu/"
...
if __name__ == '__main__':
    main("chi_la_da_nghiem_tuc_voi_em")

'''Note: run this code using cmd: uv run test/chi_la_da_nghiem_tuc_voi_em.py'''
