...
from src.locators import phuong_nam_co_cay_cao as lo
...
def main(folder_name):
    ...
    chapters_list = []
    for i in range (1, 3):
        main_url = f"https://truyenfull.vision/phuong-nam-co-cay-cao/trang-{i}/#list-chapter"
...
if __name__ == '__main__':
    main("phuong_nam_co_cay_cao")

'''Note: run this code using cmd: uv run test/phuong_nam_co_cay_cao.py'''
