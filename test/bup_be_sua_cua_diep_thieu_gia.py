...
from src.locators import bup_be_sua_cua_diep_thieu_gia as lo
...
if __name__ == '__main__':
    main("bup_be_sua_cua_diep_thieu_gia")

'''Note: run this code using cmd: uv run test/bup_be_sua_cua_diep_thieu_gia.py'''