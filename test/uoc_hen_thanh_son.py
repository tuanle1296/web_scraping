...
from src.locators import uoc_hen_thanh_son as lo
...
def main(folder_name):
    ...
    chapters_list = []
    for i in range (1, 3):
        main_url = f"https://truyenfull.vision/uoc-hen-thanh-son/trang-{i}/#list-chapter"
...
if __name__ == '__main__':
    main("uoc_hen_thanh_son")

'''Note: run this code using cmd: uv run test/uoc_hen_thanh_son.py'''