...
from src.locators import co_huong_thao as lo
...
def main(folder_name):
    ...
    chapters_list = []
    for i in range (1, 3):
        main_url = f"https://truyenfull.vision/co-huong-thao-thu-vi/trang-{i}/#list-chapter"
...
'''Note: run this code using cmd: uv run test/co_huong_thao.py'''
