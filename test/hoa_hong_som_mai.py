...
from src.locators import hoa_hong_som_mai as lo
...
def main(folder_name):
    ...
    chapters_list = []
    for i in range (1, 3):
        main_url = f"https://truyenfull.vision/hoa-hong-som-mai/trang-{i}/#list-chapter"
...
if __name__ == '__main__':
    main("hoa_hong_som_mai")

'''Note: run this code using cmd: uv run test/hoa_hong_som_mai.py'''