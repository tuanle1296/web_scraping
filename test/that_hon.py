...
from src.locators import that_hon as lo
...
def main(folder_name):
    ...
    main_url = "https://theatlamtis0108.wordpress.com/2021/08/02/that-hon-ban-tiet-bach-thai/"
    ...
    chapters_list = []
    forbidden_words = ["dang-edit", "ban-tiet-bach-thai", "hd-hau-ai"]
...
'''Note: run this code using cmd: uv run test/that_hon.py'''