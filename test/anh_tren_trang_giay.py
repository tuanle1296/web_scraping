...
from src.locators import anh_tren_trang_giay as lo
...
def main(folder_name):
    ...
    with Base(False) as crawl:
        ...
        main_url = "https://metruyenhot.vn/anh-tren-trang-giay/"
...
if __name__ == '__main__':
    main("anh_tren_trang_giay")

'''Note: run this code using cmd: uv run test/anh_tren_trang_giay.py'''
