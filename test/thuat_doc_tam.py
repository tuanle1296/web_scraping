...
from src.locators import thuat_doc_tam as lo
...
def main(folder_name):
    ...
    chapters_list = []
    for i in range (1, 3):
        main_url = f"https://truyenfull.vision/thuat-doc-tam/trang-{i}/#list-chapter"
...
'''Note: run this code using cmd: uv run test/thuat_doc_tam.py'''