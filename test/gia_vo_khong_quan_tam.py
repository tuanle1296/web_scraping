...
from src.locators import gia_vo_khong_quan_tam as lo
...
def main(folder_name):
    ...
    chapters_list = []
    for i in range (1, 3):
        main_url = f"https://truyenfull.vision/gia-vo-khong-quan-tam/trang-{i}/#list-chapter"
...
if __name__ == '__main__':
    main("gia_vo_khong_quan_tam")

'''Note: run this code using cmd: uv run test/gia_vo_khong_quan_tam.py'''
