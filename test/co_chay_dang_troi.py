...
from src.locators import co_chay_dang_troi as lo
...
def main(folder_name):
    ...
    chapters_list = []
    for i in range (1, 3):
        main_url = f"https://truyenfull.vision/co-chay-dang-troi/trang-{i}/#list-chapter"
...
if __name__ == '__main__':
    main("co_chay_dang_troi")

'''Note: run this code using cmd: uv run test/co_chay_dang_troi.py'''
