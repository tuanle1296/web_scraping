...
from src.locators import trai_tim_thieu_nu as lo
...
def main(folder_name):
    ...
    chapters_list = []
    for i in range (1, 3):
        main_url = f"https://truyenfull.vision/trai-tim-thieu-nu/trang-{i}/#list-chapter"
...
if __name__ == '__main__':
    main("trai_tim_thieu_nu")

'''Note: run this code using cmd: uv run test/trai_tim_thieu_nu.py'''