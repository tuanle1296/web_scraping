...
from src.locators import hanh_phuc_khong_ban_khong_trung_bia as lo
...
def main(folder_name):
    ...
    chapters_list = []
    for i in range (1, 3):
        main_url = f"https://truyenfull.vision/hanh-phuc-khong-ban-khong-trung-bia/trang-{i}/#list-chapter"
...
if __name__ == '__main__':
    main("hanh_phuc_khong_ban_khong_trung_bia")

'''Note: run this code using cmd: uv run test/hanh_phuc_khong_ban_khong_trung_bia.py'''
