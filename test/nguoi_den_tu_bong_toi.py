...
from src.locators import nguoi_den_tu_bong_toi as lo
...
def main(folder_name):
    ...
    main_url = "https://fjveel.wordpress.com/nguoi-den-tu-bong-toi-tang-gioi/"
...
if __name__ == '__main__':
    main("nguoi_den_tu_bong_toi")

'''Note: run this code using cmd: uv run test/nguoi_den_tu_bong_toi.py'''
