...
from src.locators import pham_ca as lo
...
def main(folder_name):
    ...
    chapters_list = []
    for i in range (1, 4):
        main_url = f"https://truyenfull.vision/pham-ca/trang-{i}/#list-chapter"
...
'''Note: run this code using cmd: uv run test/pham_ca.py'''
