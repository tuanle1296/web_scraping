...
from src.locators import bien_ca_duoi_troi_sao as lo
...
def main(folder_name):
    ...
    main_url = "https://tamsinhhuuhanhh.wordpress.com/bien-ca-duoi-troi-sao-luc-manh/"
...
if __name__ == '__main__':
    main("bien_ca_duoi_troi_sao")

'''Note: run this code using cmd: uv run test/bien_ca_duoi_troi_sao.py'''