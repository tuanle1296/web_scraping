...
from src.locators import em_chi_thich_mat_cua_anh as lo
...
def main(folder_name):
    ...
    main_url = "https://hoaroinuocchaycom.wordpress.com/2021/04/30/edit-em-chi-thich-mat-cua-anh-luc-manh-tinh/"
...
if __name__ == '__main__':
    main("em_chi_thich_mat_cua_anh")

'''Note: run this code using cmd: uv run test/em_chi_thich_mat_cua_anh.py'''