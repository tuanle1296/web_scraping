...
from src.locators import sac_mau_hon_nhan as lo
...
def main(folder_name):
    ...
    with Base(False) as crawl:
        ...
        chapters_list = []
        for i in range (1, 3):
            main_url = f"https://wikidich.com.vn/sac-mau-hon-nhan-a-hoa"
...
if __name__ == '__main__':
    main("sac_mau_hon_nhan")

'''Note: run this code using cmd: uv run test/sac_mau_hon_nhan.py'''
