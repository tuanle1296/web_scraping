...
from src.locators import dau_tay as lo
...
def main(folder_name):
    ...
    main_url = "https://tieucute.wordpress.com/2021/09/25/dau-tay-bo-hoa/"
...
'''Note: run this code using cmd: uv run test/dau_tay.py'''
