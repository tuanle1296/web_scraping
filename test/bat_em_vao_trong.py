...
from src.locators import bat_em_vao_trong as lo
    ...
    for chap_url, chap_num in chapter_data:
        try:
            ...
            if crawl.is_element_visible(lo.accept_warning_btn):
                print("Clicking accept warning button...")
...
def main(folder_name):
    ...
    chapters_list = []
    for i in range (1, 7):
        main_url = f"https://mongtruyen.com/bat-em-vao-trong-cuong-ep-thuan-phuc.html?page={i}"
...
if __name__ == '__main__':
    main("bat_em_vao_trong")

'''Note: run this code using cmd: uv run test/bat_em_vao_trong.py'''
