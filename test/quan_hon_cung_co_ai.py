...
from src.locators import quan_hon_cung_co_ai as lo
...
def main(folder_name):
    ...
    chapters_list = []
    for i in range (1, 3):
        main_url = f"https://metruyenhot.vn/quan-hon-cung-co-ai?page={i}"
...
if __name__ == '__main__':
    main("quan_hon_cung_co_ai")

'''Note: run this code using cmd: uv run test/quan_hon_cung_co_ai.py'''
