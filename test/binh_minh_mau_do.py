...
from src.locators import binh_minh_mau_do as lo
...
def main(folder_name):
    ...
    main_url = "https://dunhien0808.wordpress.com/binh-minh-vua-lo-dang-manh-ngu-nguyet/"
...
if __name__ == '__main__':
    main("binh_minh_mau_do")

'''Note: run this code using cmd: uv run test/binh_minh_mau_do.py'''