...
from src.locators import anh_biet_gio_den_tu_dau as lo
...
def main(folder_name):
    ...
    main_url = "https://liufeiyang.wordpress.com/2015/04/01/anh-biet-gio-toi-tu-dau-cuu-nguyet-hi/"
...
if __name__ == '__main__':
    main("anh_biet_gio_den_tu_dau")

'''Note: run this code using cmd: uv run test/anh_biet_gio_den_tu_dau.py'''