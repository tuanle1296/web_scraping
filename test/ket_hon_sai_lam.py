...
def crawl_from_chap_1_to_31(folder_name):
    ...
    for i in range(0, 32):
        ...
        chap_title = crawl_1.get_element_by_class(soup, locators_1.title_from_chap_1_to_31)
        chap_content = crawl_1.get_element_by_class(soup, locators_1.content_from_chap_1_to_31)
...
def crawl_from_chap_32_to_57(folder_name):
    ...
    for i in range(31, 58):
        ...
        chap_title = crawl_2.get_element_by_class(soup, locators_2.title_from_chap_32_to_57)
        chap_content = crawl_2.get_element_by_class(soup, locators_2.content_from_chap_32_to_57)
...
def crawl_ngoai_truyen_1(folder_name, password):
    ...
    with open("testdata.html", 'r') as file:
        ...
        chap_title = crawl_3.get_element_by_class(beautifulSoupText, locators_3.title_from_chap_32_to_57)
        chap_content = crawl_3.get_element_by_class(beautifulSoupText, locators_3.content_from_chap_32_to_57)
...
def crawl_ngoai_truyen_2(folder_name, password):
    ...
    with open("testdata2.html", 'r') as file:
        beautifulSoupText = BeautifulSoup(file.read(), 'html.parser')
        chap_title = crawl_4.get_element_by_class(beautifulSoupText, locators_4.title_from_chap_32_to_57)
        chap_content = crawl_4.get_element_by_class(beautifulSoupText, locators_4.content_from_chap_32_to_57)
...
def crawl_ngoai_truyen_3(folder_name, password):
    ...
    with open("testdata3.html", 'r') as file:
        beautifulSoupText = BeautifulSoup(file.read(), 'html.parser')
        chap_title = crawl_5.get_element_by_class(beautifulSoupText, locators_5.title_from_chap_32_to_57)
        chap_content = crawl_5.get_element_by_class(beautifulSoupText, locators_5.content_from_chap_32_to_57)
