...
from src.locators import tinh_yeu_cua_chung_ta as lo
...
def crawl_worker(chapter_data, folder_name):
    ...
    passwords = ["khongbietnendatpassgi", "motngankhongtramhaimuoiba", "haimuoi"]
...
def main(folder_name):
    ...
    main_url = "https://augustamin08.wordpress.com/tinh-yeu-cua-chung-ta-xuan-phong-luu-hoa/"
    ...
    chapters_list = []
    forbidden_words = ["pass-tinh-yeu", "wattpad"]
...
if __name__ == '__main__':
    main("tinh_yeu_cua_chung_ta")

'''Note: run this code using cmd: uv run test/tinh_yeu_cua_chung_ta.py'''