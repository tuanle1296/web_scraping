...
from src.locators import dong_long as lo
...
def main(folder_name):
    ...
    main_url = "https://vouusontrang294893128.wordpress.com/donglong-levu/"
...
'''Note: run this code using cmd: uv run test/dong_long.py'''
