...
from src.locators import doi_em_tro_ve_se_noi_yeu_em as lo
...
def main(folder_name):
    ...
    chapters_list = []
    for i in range (1, 3):
        main_url = f"https://truyenfull.vision/doi-em-tro-ve-se-noi-yeu-em/trang-{i}/#list-chapter"
...
if __name__ == '__main__':
    main("doi_em_tro_ve_se_noi_yeu_em")

'''Note: run this code using cmd: python3 test/doi_em_tro_ve_se_noi_yeu_em.py'''
