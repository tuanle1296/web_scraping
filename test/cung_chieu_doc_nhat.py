...
from src.locators import cung_chieu_doc_nhat as lo
...
def main(folder_name):
    ...
    main_url = "https://depbietbay.wordpress.com/2020/05/25/cung-chieu-doc-nhat-nga-huu-giai-duoc/"
    ...
    chapters_list = []
    forbidden_words = ["goi-y-pass", "su-dau-hang-ngot-ngao"]
...
if __name__ == '__main__':
    main("cung_chieu_doc_nhat")

'''Note: run this code using cmd: uv run test/cung_chieu_doc_nhat.py'''