...
from src.locators import vung_trom_khong_the_giau as lo
...
def main(folder_name):
    ...
    chapters_list = []
    for i in range (1, 6):
        main_url = f"https://mongtruyen.com/vung-trom-khong-the-giau.html?page={i}"
...
if __name__ == '__main__':
    main("vung_trom_khong_the_giau")

'''Note: run this code using cmd: uv run test/vung_trom_khong_the_giau.py'''
