...
from src.locators import cap_doi_nong_chay as lo
...
def main(folder_name):
    ...
    main_url = "https://vuakhoaihoduong.wordpress.com/2021/05/29/cap-doi-nong-chay-giao-xuan-binh/"
    ...
    chapters_list = []
    forbidden_words = ["share", "relatedposts"]
...
if __name__ == '__main__':
    main("cap_doi_nong_chay")

'''Note: run this code using cmd: uv run test/cap_doi_nong_chay.py'''