...
from src.locators import nam_thu_hai_sau_khi_ket_hon as lo
...
def main(folder_name):
    ...
    for i in range (1, 99):
        main_url = f"https://lantruyen.vn/nam-thu-hai-sau-khi-ket-hon.html?chuong={i}"
...
if __name__ == '__main__':
    main("nam_thu_hai_sau_khi_ket_hon_2")

'''Note: run this code using cmd: uv run test/nam_thu_hai_sau_khi_ket_hon.py'''
