...
from src.locators import lo_hen_cung_xuan as lo
...
def crawl_worker(chapter_data, folder_name):
    ...
    passwords = ["kemduong", "kemlot", "oplung", "phannen", "phanphu", "bangphan", "miengdan", "mascarazeesea", "cuongluc", "suarua", "xitkhoa", "thung30", "chaixit", "suaduong"]
...
def main(folder_name):
    ...
    main_url = "https://anintrovert1.wordpress.com/lo-hen-cung-xuan-lap-dien-tho-dau-ti/"
...
if __name__ == '__main__':
    main("lo_hen_cung_xuan")

'''Note: run this code using cmd: uv run test/lo_hen_cung_xuan.py'''
