...
from src.locators import the_gioi_tang_em_cho_anh as lo
...
def main(folder_name):
    ...
    main_url = "https://muadongsaigon.wordpress.com/the-gioi-tang-anh-anh-cho-em/"
...
if __name__ == '__main__':
    main("the_gioi_tang_em_cho_anh")

'''Note: run this code using cmd: uv run test/the_gioi_tang_em_cho_anh.py'''