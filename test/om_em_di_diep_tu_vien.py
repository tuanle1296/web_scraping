...
from src.locators import om_em_di_diep_tu_vien as lo
...
def main(folder_name):
    ...
    chapters_list = []
    for i in range (1, 4):
        main_url = f"https://truyenfull.vision/om-em-di-diep-tu-vien/trang-{i}/#list-chapter"
...
if __name__ == '__main__':
    main("om_em_di_diep_tu_vien")

'''Note: run this code using cmd: uv run test/om_em_di_diep_tu_vien.py'''