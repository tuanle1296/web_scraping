...
from src.locators import gio_nam_va_hoa_hong as lo
...
def main(folder_name):
    ...
    chapters_list = []
    for i in range (1, 3):
        main_url = f"https://truyenfull.vision/gio-nam-va-hoa-hong/trang-{i}/#list-chapter"
...
if __name__ == '__main__':
    main("gio_nam_va_hoa_hong")

'''Note: run this code using cmd: uv run test/gio_nam_va_hoa_hong.py'''
