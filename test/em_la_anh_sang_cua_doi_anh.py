...
from src.locators import em_la_anh_sang_cua_doi_anh as lo
...
def main(folder_name):
    ...
    chapters_list = []
    for i in range (1, 3):
        main_url = f"https://truyenfull.vision/em-la-anh-sang-cua-doi-anh/trang-{i}/#list-chapter"
...
if __name__ == '__main__':
    main("em_la_anh_sang_cua_doi_anh")

'''Note: run this code using cmd: uv run test/em_la_anh_sang_cua_doi_anh.py'''