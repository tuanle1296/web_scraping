...
from src.locators import chiec_coi_trang as lo
...
def main(folder_name):
    ...
    main_url = "https://ruanru06.wordpress.com/%E2%99%9B-truyen-nha-minh%E2%99%9B/chiec-coi-trang-liem-thap-li/"
...
if __name__ == '__main__':
    main("chiec_coi_trang")

'''Note: run this code using cmd: uv run test/chiec_coi_trang.py'''
