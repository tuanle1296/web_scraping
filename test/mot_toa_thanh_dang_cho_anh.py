...
from src.locators import mot_toa_thanh_dang_cho_anh as lo
...
def main(folder_name):
    ...
    with Base(False) as crawl:
        ...
        chapters_list = []
        for i in range (1, 3):
            main_url = f"https://metruyenhot.vn/mot-toa-thanh-dang-cho-anh?page={i}"
...
if __name__ == '__main__':
    main("mot_toa_thanh_dang_cho_anh")

'''Note: run this code using cmd: uv run test/mot_toa_thanh_dang_cho_anh.py'''
