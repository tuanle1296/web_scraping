...
from src.locators import nhiet_do_co_the_cua_ac_ma as lo
...
def main(folder_name):
    ...
    chapters_list = []
    for i in range (1, 4):
        main_url = f"https://truyenfull.vision/nhiet-do-co-the-cua-ac-ma/trang-{i}/#list-chapter"
...
if __name__ == '__main__':
    main("nhiet_do_co_the_cua_ac_ma")

'''Note: run this code using cmd: uv run test/nhiet_do_co_the_cua_ac_ma.py'''
