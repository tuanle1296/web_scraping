...
from src.locators import chan_troi_goc_be as lo
...
def main(folder_name):
    ...
    with Base(False) as crawl:
        ...
        chapters_list = []
        # for i in range (1, 3):
        main_url = f"https://truyencom.com/chan-troi-goc-be.207/"
...
if __name__ == '__main__':
    main("chan_troi_goc_be")

'''Note: run this code using cmd: uv run test/chan_troi_goc_be.py'''
