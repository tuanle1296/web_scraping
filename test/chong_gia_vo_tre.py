...
from src.locators import chong_gia_vo_tre as lo
...
def main(folder_name):
    ...
    main_url = "https://truyenfull.vision/chong-gia-vo-tre/"
...
if __name__ == '__main__':
    main("chong_gia_vo_tre")

'''Note: run this code using cmd: uv run test/chong_gia_vo_tre.py'''
