...
from src.locators import duc_phat_va_nang as lo
...
def main(folder_name):
    ...
    chapters_list = []
    for i in range (1, 3):
        main_url = f"https://truyenfull.vision/duc-phat-va-nang/trang-{i}/#list-chapter"
...
if __name__ == '__main__':
    main("duc_phat_va_nang")

'''Note: run this code using cmd: uv run test/duc_phat_va_nang.py'''
