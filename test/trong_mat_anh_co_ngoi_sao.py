...
from src.locators import trong_mat_anh_co_ngoi_sao as lo
...
def main(folder_name):
    ...
    chapters_list = []
    main_url = f"https://truyenfull.vision/trong-mat-anh-co-ngoi-sao/"
...
if __name__ == '__main__':
    main("trong_mat_anh_co_ngoi_sao")

'''Note: run this code using cmd: uv run test/trong_mat_anh_co_ngoi_sao.py'''
