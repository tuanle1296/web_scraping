...
from src.locators import hom_qua_vui_ve as lo
...
def crawl_worker(chapter_data, folder_name):
    ...
    passwords = ["thalassemia", "hongkong", "normanbethune", "gayxuong", "sistercon", "doitritrung", "sudoku", "giandiep", "ProgesteronE"]
...
def main(folder_name):
    ...
    main_url = "https://xiaoyang0811.wordpress.com/2019/05/13/edit-hom-qua-vui-ve-ha-cam-lam/"
    ...
    chapters_list = []
    forbidden_words = ["love", "pass", "wattpad", "edit", "goi-thuc-an", "tinh-ruou"]
...
'''Note: run this code using cmd: uv run test/hom_qua_vui_ve.py'''