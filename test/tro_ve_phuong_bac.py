...
from src.locators import tro_ve_phuong_bac as lo
...
def main(folder_name):
    ...
    main_url = "https://daunonchaycanh.wordpress.com/tvpb/"
...
if __name__ == '__main__':
    main("tro_ve_phuong_bac")

'''Note: run this code using cmd: uv run test/tro_ve_phuong_bac.py'''