...
from src.locators import xin_em_o_lai_ben_anh as lo
...
def main(folder_name):
    ...
    with Base(False) as crawl:
        ...
        main_url = "https://wattpad.com.vn/xin-em-o-lai-ben-anh"
...
if __name__ == '__main__':
    main("xin_em_o_lai_ben_anh")

'''Note: run this code using cmd: uv run test/xin_em_o_lai_ben_anh.py'''