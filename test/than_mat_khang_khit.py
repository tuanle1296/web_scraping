...
from src.locators import than_mat_khang_khit as lo
...
def crawl_worker(chapter_data, folder_name):
    ...
    passwords = "Uyển bé bỏng có một ước mơ là muốn được gần gũi với Kim Taehyung."
    ...
    for chap_url, chap_num in chapter_data:
        ...
        if crawl.is_element_visible(lo.password_input_field):
            ...
            if crawl.is_element_visible(lo.password_input_field) is False:
                    print(f"Password field not found for Chap {chap_num}.")  # breaks inner password loop
...
def main(folder_name):
    ...
    main_url = "https://banhtroinee.wordpress.com/edit-h-than-mat-khang-khit-bao-bat-tri/"
...
if __name__ == '__main__':
    main("than_mat_khang_khit")

'''Note: run this code using cmd: uv run test/than_mat_khang_khit.py'''
