...
from src.locators import sac_mau_am as lo
...
def main(folder_name):
    ...
    chapters_list = []
    # for i in range (1, 3):
    main_url = "https://wattpad.com.vn/sac-mau-am-sanh-sanh-bat-hap"
...
'''Note: run this code using cmd: uv run test/sac_mau_am.py'''
