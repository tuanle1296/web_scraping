...
from src.locators import thich as lo
    ...
    for chap_url, chap_num in chapter_data:
        try:
            ...
            if response.status_code == 200:
                ...
                content_element = soup.select_one(lo.chap_content[1])
...
'''Note: run this code using cmd: python3 test/thich.py'''
