...
from src.locators import doi_mua_tanh as lo
...
def main(folder_name):
    ...
    main_url = "https://joanmia.wordpress.com/doi-mua-tanh-uy-khong/"
...
'''Note: run this code using cmd: uv run test/doi_mua_tanh.py'''