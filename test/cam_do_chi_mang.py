...
from src.locators import cam_do_chi_mang as lo
...
def main(folder_name):
    ...
    with Base(False) as crawl:
        ...
        main_url = "https://gacsach3.top/cam-do-chi-mang_mac-bao-phi-bao.full"
...
if __name__ == '__main__':
    main("cam_do_chi_mang")

'''Note: run this code using cmd: uv run test/cam_do_chi_mang.py'''