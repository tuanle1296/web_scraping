...
from src.locators import em_thay_nui_xanh as lo
...
def main(folder_name):
    ...
    main_url = "https://jinss.wordpress.com/truyen-da-hoan/em-thay-nui-xanh/"
    ...
    chapters_list = []
    forbidden_words = ["suu-tam-anh-dep"]
...
if __name__ == '__main__':
    main("em_thay_nui_xanh")

'''Note: run this code using cmd: uv run test/em_thay_nui_xanh.py'''