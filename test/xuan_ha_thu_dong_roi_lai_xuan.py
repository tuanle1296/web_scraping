...
from src.locators import xuan_ha_thu_dong_roi_lai_xuan as lo
...
def main(folder_name):
    ...
    main_url = "https://truyenfull.vision/xuan-ha-thu-dong-roi-lai-xuan/"
...
if __name__ == '__main__':
    main("xuan_ha_thu_dong_roi_lai_xuan")

'''Note: run this code using cmd: uv run test/xuan_ha_thu_dong_roi_lai_xuan.py'''