...
from src.locators import ngay_mai_van_con_yeu_em as lo
...
def main(folder_name):
    ...
    chapters_list = []
    for i in range (1, 6):
        main_url = f"https://mongtruyen.com/ngay-mai-van-con-yeu-em.html?page={i}"
...
if __name__ == '__main__':
    main("ngay_mai_van_con_yeu_em")

'''Note: run this code using cmd: uv run test/ngay_mai_van_con_yeu_em.py'''
