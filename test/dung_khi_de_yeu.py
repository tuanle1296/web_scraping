...
from src.locators import dung_khi_de_yeu as lo
...
def main(folder_name):
    ...
    chapters_list = []
    for i in range (1, 3):
        main_url = f"https://truyenfull.vision/dung-khi-de-yeu/trang-{i}/#list-chapter"
...
if __name__ == '__main__':
    main("dung_khi_de_yeu")

'''Note: run this code using cmd: uv run test/dung_khi_de_yeu.py'''
