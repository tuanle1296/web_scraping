...
from src.locators import nghe_noi_em_thich_toi as lo
...
def main(folder_name):
    ...
    chapters_list = []
    for i in range (1, 9):
        main_url = f"https://truyenfull.vision/nghe-noi-em-thich-toi/trang-{i}/#list-chapter"
...
if __name__ == '__main__':
    main("nghe_noi_em_thich_toi")

'''Note: run this code using cmd: uv run test/nghe_noi_em_thich_toi.py'''
