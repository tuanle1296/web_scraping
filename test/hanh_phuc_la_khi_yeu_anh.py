...
from src.locators import hanh_phuc_la_khi_yeu_anh as lo
...
def main(folder_name):
    ...
    main_url = "https://voivoieditorials.wordpress.com/la-xinh-tren-cay-vui-long-khong-ngat/hplkya-mong-tieu-nhi/"
    ...
    chapters_list = []
    forbidden_words = ["wikidich", "dichtienghoa", "vivi3010", "wattpad", "phongphongtam", "haibonthang7", "chenchensaohoa"]
...
if __name__ == '__main__':
    main("hanh_phuc_la_khi_yeu_anh")

'''Note: run this code using cmd: uv run test/hanh_phuc_la_khi_yeu_anh.py'''