...
from src.locators import em_o_ben_ai_cung_la_khoang_trong_trong_anh as lo
...
def main(folder_name):
    ...
    main_url = "https://truyenfull.vision/em-o-ben-ai-cung-deu-la-khoang-trong-trong-anh/"
...
if __name__ == '__main__':
    main("em_o_ben_ai_cung_la_khoang_trong_trong_anh")

'''Note: run this code using cmd: uv run test/em_o_ben_ai_cung_la_khoang_trong_trong_anh.py'''