...
from src.locators import loi_keo as lo
...
def main(folder_name):
    ...
    chapters_list = []
    for i in range (1, 3):
        main_url = f"https://truyenfull.vision/loi-keo/trang-{i}/#list-chapter"
...
'''Note: run this code using cmd: uv run test/loi_keo.py'''
