...
from src.locators import dem_dai_o_bac_dao as lo
...
def main(folder_name):
    ...
    chapters_list = []
    for i in range (1, 3):
        main_url = f"https://truyenfull.vision/dem-dai-o-bac-dao-giai-tong/trang-{i}/#list-chapter"
...
if __name__ == '__main__':
    main("dem_dai_o_bac_dao")

'''Note: run this code using cmd: uv run test/dem_dai_o_bac_dao.py'''
