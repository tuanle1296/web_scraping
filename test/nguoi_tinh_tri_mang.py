...
from src.locators import nguoi_tinh_tri_mang as lo
...
def main(folder_name):
    ...
    main_url = "https://fjveel.wordpress.com/10886-2/"
...
if __name__ == '__main__':
    main("nguoi_tinh_tri_mang")

'''Note: run this code using cmd: uv run test/nguoi_tinh_tri_mang.py'''
