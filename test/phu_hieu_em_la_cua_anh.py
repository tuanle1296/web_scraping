...
from src.locators import phu_hieu_em_la_cua_anh as lo
...
def main(folder_name):
    ...
    chapters_list = []
    for i in range (1, 7):
        main_url = f"https://mongtruyen.com/phu-hieu-em-la-cua-anh.html?page={i}"
...
if __name__ == '__main__':
    main("phu_hieu_em_la_cua_anh")

'''Note: run this code using cmd: uv run test/phu_hieu_em_la_cua_anh.py'''
