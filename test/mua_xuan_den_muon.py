...
from src.locators import mua_xuan_den_muon as lo
...
def main(folder_name):
    ...
    chapters_list = []
    for i in range (1, 5):
        main_url = f"https://mongtruyen.com/mua-xuan-den-muon.html?page={i}"
...
if __name__ == '__main__':
    main("mua_xuan_den_muon")

'''Note: run this code using cmd: uv run test/mua_xuan_den_muon.py'''
