...
from src.locators import hai_sao_3 as lo
...
def main(folder_name):
    ...
    chapters_list = []
    for i in range (1, 3):
        main_url = f"https://truyenfull.vision/hai-sao-3/trang-{i}/#list-chapter"
...
'''Note: run this code using cmd: uv run test/hai_sao_3.py'''