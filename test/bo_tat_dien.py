...
from src.locators import bo_tat_dien as lo
...
def main(folder_name):
    ...
    main_url = "https://luclacnho2810.wordpress.com/bo-tat-dien-cuong-qua/"
...
'''Note: run this code using cmd: uv run test/bo_tat_dien.py'''
