...
from src.locators import em_la_tat_ca_nhung_gi_anh_khao_khat as lo
...
def main(folder_name):
    ...
    main_url = "https://fjveel.wordpress.com/truyen-dang-dich/em-la-tat-ca-nhung-gi-anh-khao-khat/"
...
if __name__ == '__main__':
    main("em_la_tat_ca_nhung_gi_anh_khao_khat")

'''Note: run this code using cmd: uv run test/em_la_tat_ca_nhung_gi_anh_khao_khat.py'''