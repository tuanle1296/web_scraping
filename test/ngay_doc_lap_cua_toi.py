...
from src.locators import ngay_doc_lap_cua_toi as lo
...
def main(folder_name):
    ...
    with Base(False) as crawl:
        ...
        main_url = "https://miumiucorner.com/ngay-doc-lap-cua-toi/"
...
if __name__ == '__main__':
    main("ngay_doc_lap_cua_toi")

'''Note: run this code using cmd: uv run test/ngay_doc_lap_cua_toi.py'''