...
from src.locators import hoang_hon_mong_manh as lo
...
def main(folder_name):
    ...
    main_url = "https://gacsach3.top/anh-hoang-hon-mong-manh_tinh-khong-lam-he.full"
...
if __name__ == '__main__':
    main("hoang_hon_mong_manh")

'''Note: run this code using cmd: uv run test/hoang_hon_mong_manh.py'''