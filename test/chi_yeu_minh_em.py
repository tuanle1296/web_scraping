...
from src.locators import chi_yeu_minh_em as lo
...
def main(folder_name):
    ...
    main_url = "https://blowzedgirl3003.wordpress.com/chi-yeu-minh-em/"
...
if __name__ == '__main__':
    main("chi_yeu_minh_em")

'''Note: run this code using cmd: uv run test/chi_yeu_minh_em.py'''