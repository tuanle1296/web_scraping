...
from src.locators import phon_gian as lo
...
def main(folder_name):
    ...
    chapters_list = []
    for i in range (1, 3):
        main_url = f"https://truyenfull.vision/phon-gian/trang-{i}/#list-chapter"
...
'''Note: run this code using cmd: uv run test/phon_gian.py'''
