...
from src.locators import tron_thoat_duoi_day_bien as lo
...
def main(folder_name):
    ...
    main_url = "https://heliophilia3.wordpress.com/2024/10/14/van-an-8/"
    ...
    chapters_list = []
    forbidden_words = ["share", "drive", "chuong-136", "van-an-10", "van-an-32"]
...
if __name__ == '__main__':
    main("tron_thoat_duoi_day_bien")

'''Note: run this code using cmd: uv run test/tron_thoat_duoi_day_bien.py'''