...
from src.locators import luoi_dao_diu_dang as lo
...
def main(folder_name):
    ...
    chapters_list = []
    for i in range (1, 5):
        main_url = f"https://mongtruyen.com/luoi-dao-diu-dang.html?page={i}"
...
if __name__ == '__main__':
    main("luoi_dao_diu_dang")

'''Note: run this code using cmd: uv run test/luoi_dao_diu_dang.py'''
