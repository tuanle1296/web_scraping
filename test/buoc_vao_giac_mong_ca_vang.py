...
from src.locators import buoc_vao_giac_mong_ca_vang as lo
...
def main(folder_name):
    ...
    chapters_list = []
    main_url = "https://lanho2002.wordpress.com/2023/07/24/buoc-vao-giac-mong-ca-vang/"
...
if __name__ == '__main__':
    main("buoc_vao_giac_mong_ca_vang")

'''Note: run this code using cmd: uv run test/buoc_vao_giac_mong_ca_vang.py'''