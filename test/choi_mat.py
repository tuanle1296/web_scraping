...
from src.locators import choi_mat as lo
...
def main(folder_name):
    ...
    chapters_list = []
    for i in range (1, 4):
        main_url = f"https://truyenfull.vision/choi-mat/trang-{i}/#list-chapter"
...
'''Note: run this code using cmd: uv run test/choi_mat.py'''
