...
from src.locators import du_am_van_con_thoang_ben_tai as lo
...
def main(folder_name):
    ...
    main_url = "https://sqsq1306.wordpress.com/2021/08/05/du-am-van-con-thoang-ben-tai-thu-vien/"
...
if __name__ == '__main__':
    main("du_am_van_con_thoang_ben_tai")

'''Note: run this code using cmd: uv run test/du_am_van_con_thoang_ben_tai.py'''