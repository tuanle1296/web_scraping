...
from src.locators import son_nam_hai_bac as lo
...
def main(folder_name):
    ...
    chapters_list = []
    for i in range (1, 3):
        main_url = f"https://truyenfull.vision/son-nam-hai-bac/trang-{i}/#list-chapter"
...
if __name__ == '__main__':
    main("son_nam_hai_bac")

'''Note: run this code using cmd: uv run test/son_nam_hai_bac.py'''
