...
from src.locators import cuc_non_trong_tam_mat as lo
...
def main(folder_name):
    ...
    main_url = "https://gocnhocuagann.wordpress.com/2025/09/14/cuc-non-trong-tam-mat-sam-man/"
...
if __name__ == '__main__':
    main("cuc_non_trong_tam_mat")

'''Note: run this code using cmd: uv run test/cuc_non_trong_tam_mat.py'''
