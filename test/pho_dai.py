...
from src.locators import pho_dai as lo
...
def main(folder_name):
    ...
    chapters_list = []
    for i in range (1, 3):
        main_url = f"https://truyenfull.vision/pho-dai/trang-{i}/#list-chapter"
...
'''Note: run this code using cmd: uv run test/pho_dai.py'''