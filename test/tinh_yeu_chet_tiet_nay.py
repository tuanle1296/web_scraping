...
from src.locators import tinh_yeu_chet_tiet_nay as lo
...
def main(folder_name):
    ...
    main_url = "https://gocnhocuagann.wordpress.com/2019/08/23/tinh-yeu-chet-tiet-nay-loan/"
...
if __name__ == '__main__':
    main("tinh_yeu_chet_tiet_nay")

'''Note: run this code using cmd: uv run test/tinh_yeu_chet_tiet_nay.py'''