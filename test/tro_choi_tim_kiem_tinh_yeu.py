...
from src.locators import tro_choi_tim_kiem_tinh_yeu as lo
...
def main(folder_name):
    ...
    chapters_list = []
    for i in range (1, 3):
        main_url = f"https://truyenfull.vision/tro-choi-tim-kiem-tinh-yeu-con-duong-den-ben-em/trang-{i}/#list-chapter"
...
if __name__ == '__main__':
    main("tro_choi_tim_kiem_tinh_yeu")

'''Note: run this code using cmd: uv run test/tro_choi_tim_kiem_tinh_yeu.py'''
