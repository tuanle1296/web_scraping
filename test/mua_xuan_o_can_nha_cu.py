...
from src.locators import mua_xuan_o_can_nha_cu as lo
...
def main(folder_name):
    ...
    chapters_list = []
    for i in range (1, 3):
        main_url = f"https://truyenfull.vision/mua-xuan-o-can-nha-cu/trang-{i}/#list-chapter"
...
if __name__ == '__main__':
    main("mua_xuan_o_can_nha_cu")

'''Note: run this code using cmd: uv run test/mua_xuan_o_can_nha_cu.py'''