...
from src.locators import coi_xay_gio_mau_xanh as lo
...
def main(folder_name):
    ...
    chapters_list = []
    for i in range (1, 3):
        main_url = f"https://truyenfull.vision/coi-xay-gio-mau-xanh-mong-tieu-nhi/trang-{i}/#list-chapter"
...
if __name__ == '__main__':
    main("coi_xay_gio_mau_xanh")

'''Note: run this code using cmd: uv run test/coi_xay_gio_mau_xanh.py'''