...
from src.locators import me_tinh_berlin as lo
...
def main(folder_name):
    ...
    main_url = "https://yiniansicheng.wordpress.com/2017/02/25/me-tinh-berlin-engelchen/"
...
'''Note: run this code using cmd: uv run test/me_tinh_berlin.py'''