...
from src.locators import dam_lay_mua_xuan as lo
...
def main(folder_name):
    ...
    main_url = "https://ngocscorner1.wordpress.com/2024/01/27/dam-lay-mua-xuan/"
    ...
    chapters_list = []
    forbidden_words = ["facebook", "ngocscorner2"]
...
if __name__ == '__main__':
    main("dam_lay_mua_xuan")

'''Note: run this code using cmd: uv run test/dam_lay_mua_xuan.py'''