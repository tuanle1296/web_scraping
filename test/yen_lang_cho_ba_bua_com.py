...
from src.locators import yen_lang_cho_ba_bua_com as lo
...
def main(folder_name):
    ...
    main_url = "https://wattpad.com.vn/yen-lang-cho-ba-bua-com"
...
if __name__ == '__main__':
    main("yen_lang_cho_ba_bua_com")

'''Note: run this code using cmd: uv run test/yen_lang_cho_ba_bua_com.py'''