...
from src.locators import nghe_noi_chu_yeu_loli as lo
...
def main(folder_name):
    ...
    chapters_list = []
    for i in range (1, 3):
        main_url = f"https://truyenfull.vision/nghe-noi-chu-yeu-loli/trang-{i}/#list-chapter"
...
if __name__ == '__main__':
    main("nghe_noi_chu_yeu_loli")

'''Note: run this code using cmd: uv run test/nghe_noi_chu_yeu_loli.py'''