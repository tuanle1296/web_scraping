...
from src.locators import chay_bong as lo
...
def main(folder_name):
    ...
    chapters_list = []
    for i in range (1, 3):
        main_url = f"https://truyenfull.vision/chay-bong-cu-cu-mieu/trang-{i}/#list-chapter"
...
'''Note: run this code using cmd: uv run test/chay_bong.py'''