...
from src.locators import tham_luyen as lo
...
def main(folder_name):
    ...
    main_url = "https://ninahouse01.wordpress.com/truyen-hoan/hd-tham-luyen-nghe-da-hi/"
...
'''Note: run this code using cmd: uv run test/tham_luyen.py'''