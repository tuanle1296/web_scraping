...
from src.locators import mot_ngay_mua as lo
...
def main(folder_name):
    ...
    chapters_list = []
    for i in range (1, 3):
        main_url = f"https://truyenfull.vision/mot-ngay-mua/trang-{i}/#list-chapter"
...
'''Note: run this code using cmd: uv run test/mot_ngay_mua.py'''
