...
from src.locators import mac_phu_han_ha as lo
...
def main(folder_name):
    ...
    chapters_list = []
    for i in range (1, 4):
        main_url = f"https://truyenfull.vision/mac-phu-han-ha/trang-{i}/#list-chapter"
...
'''Note: run this code using cmd: uv run test/mac_phu_han_ha.py'''
