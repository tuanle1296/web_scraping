...
from src.locators import dong_tam_vi_em as lo
...
def main(folder_name):
    ...
    chapters_list = []
    for i in range (1, 4):
        main_url = f"https://mongtruyen.com/dong-tam-vi-em.html?page={i}"
...
'''Note: run this code using cmd: uv run test/dong_tam_vi_em.py'''
