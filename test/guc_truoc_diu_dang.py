...
from src.locators import guc_truoc_diu_dang as lo
...
def main(folder_name):
    ...
    chapters_list = []
    for i in range (1, 3):
        main_url = f"https://truyenfull.vision/guc-truoc-diu-dang/trang-{i}/#list-chapter"
...
if __name__ == '__main__':
    main("guc_truoc_diu_dang")

'''Note: run this code using cmd: uv run test/guc_truoc_diu_dang.py'''