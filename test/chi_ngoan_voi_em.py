...
from src.locators import chi_ngoan_voi_em as lo
...
def main(folder_name):
    ...
    main_url = "https://gacnhomongmo.wordpress.com/chi-ngoan-voi-em-tri-anh/"
...
if __name__ == '__main__':
    main("chi_ngoan_voi_em")

'''Note: run this code using cmd: uv run test/chi_ngoan_voi_em.py'''