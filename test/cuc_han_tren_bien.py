...
from src.locators import cuc_han_tren_bien as lo
...
def main(folder_name):
    ...
    main_url = "https://bidoteam.wordpress.com/2020/05/25/cuc-han-trien-mien/"
...
if __name__ == '__main__':
    main("cuc_han_tren_bien")

'''Note: run this code using cmd: uv run test/cuc_han_tren_bien.py'''
