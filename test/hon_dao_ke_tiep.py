...
from src.locators import hon_dao_ke_tiep as lo
...
def main(folder_name):
    ...
    chapters_list = []
    for i in range (1, 3):
        main_url = f"https://truyenfull.vision/hon-dao-ke-tiep/trang-{i}/#list-chapter"
...
if __name__ == '__main__':
    main("hon_dao_ke_tiep")

'''Note: run this code using cmd: uv run test/hon_dao_ke_tiep.py'''
