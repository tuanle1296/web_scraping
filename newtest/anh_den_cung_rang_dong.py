...
def main(folder_name):
    ...
    chapters_list = []
    for i in range (1, 5):
        main_url = f"https://mongtruyen.com/anh-den-cung-rang-dong.html?page={i}"
...
if __name__ == '__main__':
    main("anh_den_cung_rang_dong")

'''Note: run this code using cmd: uv run test/anh_den_cung_rang_dong.py'''
